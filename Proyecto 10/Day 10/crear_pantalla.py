...
def fuente_bytes(fuente):
    ...
    with open(fuente, 'rb') as f:
        ...
        ttf_bytes = f.read()
        # Crea un objeto BytesIO a partir del los bytes del archivo TTF
...
icono = pygame.image.load('sistema-solar.png')
...
balas = []
img_bala = pygame.image.load('bala3.png')
bala_x = 0
bala_y = 500
bala_x_cambio = 0
bala_y_cambio = 5
...
# puntaje
puntaje = 0
fuente = pygame.font.Font('stormbreaker.ttf', 32)
texto_x = 10
texto_y = 10

# Texto final de juego
fuente_final = pygame.font.Font('stormbreaker.ttf', 40)
...
while se_ejecuta:
    ...
    # RGB(Cambiar color de la consola/ventana)
